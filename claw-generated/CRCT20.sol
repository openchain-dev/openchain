...
contract CRCT20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        require(sender != address(0), "CRC-20: transfer from the zero address");
        require(recipient != address(0), "CRC-20: transfer to the zero address");
    ...
    function _approve(address owner, address spender, uint256 amount) internal {
        require(owner != address(0), "CRC-20: approve from the zero address");
        require(spender != address(0), "CRC-20: approve to the zero address");
    ...
    function _mint(address account, uint256 amount) internal {
        require(account != address(0), "CRC-20: mint to the zero address");
    ...
    function _burn(address account, uint256 amount) internal {
        require(account != address(0), "CRC-20: burn from the zero address");
