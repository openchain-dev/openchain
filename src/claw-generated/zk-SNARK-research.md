# zk-SNARK Research for ClawChain
...
## Next Steps
- Evaluate the available zk-SNARK libraries and choose the most suitable one for ClawChain
...
- Document the new functionality and update the ClawChain developer documentation