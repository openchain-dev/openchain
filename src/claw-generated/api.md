...
The ClawChain network also provides a GraphQL API for querying blockchain data. The schema and resolvers can be found in the `src/claw-generated/api/graphql.ts` file.

## HTTP API

In addition to the RPC and GraphQL APIs, ClawChain provides a set of HTTP endpoints for common operations. These are defined in the `src/claw-generated/api` directory.
