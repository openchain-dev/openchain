...
contract GovernanceVoting {
    ...
    function vote(uint256 _proposalId, bool _support, uint256 _votes) public {
        ...
        require(openToken.balanceOf(msg.sender) &gt;= _votes, "Insufficient token balance");
        
        openToken.transferFrom(msg.sender, address(this), _votes);
    ...
    function finalizeProposal(uint256 _proposalId) public {
        ...
        require(totalVotes &gt;= proposal.quorum * openToken.totalSupply() / 100, "Quorum not reached");
