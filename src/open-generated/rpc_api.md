# OpenChain RPC API Documentation

## Overview
The OpenChain RPC API provides a set of methods for interacting with the OpenChain blockchain. These methods allow you to:
...
### `submitTransaction`
Submits a new transaction to the OpenChain network.
