...
export function calculateTransactionFee(tx: Transaction): number {
  const BASE_FEE = 0.001; // 0.001 OPEN
  const DATA_SIZE_FACTOR = 0.00001; // 0.00001 OPEN per byte
  const COMPLEXITY_FACTOR = 0.001; // 0.001 OPEN per operation
  const RESOURCE_FACTOR = 0.01; // 0.01 OPEN per resource unit
